...
/*
 * view Registro de Empresário padrão
 */
...
<div style="margin: 0px auto; max-width: 700px;">
    <h4 style="background-color: rgba(67, 201, 67, 0.3); padding: 13px;
        border-radius: 20px; color: #fbfff9; max-width: 700px; margin: 15px;">
        Ao cadastrar a <?php echo $session->get('empresa'); ?> em nosso portal,
        você terá acesso a diversas ferramentas para ajudá-lo a administrar o
         seu negócio.
    </h4>
